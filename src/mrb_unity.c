...
void
mrb_unity_abort_callback(mrb_state *mrb, mrb_value exc)
{
...
// Other
MRB_API mrb_value mrb_unity_funcall_argv(mrb_state *mrb, mrb_value val, const char *name, mrb_int argc,const mrb_value *args)
{
...
void
mrb_mruby_unity_gem_init(mrb_state* mrb)
{
}

void
mrb_mruby_unity_gem_final(mrb_state* mrb)
{
}
